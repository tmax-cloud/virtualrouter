...
## Fetch virtual-router and its dependencies

Like the rest of Kubernetes, virtual-router has used
...
```sh
git clone https://github.com/kubernetes/virtual-router.git
cd virtual-router
```
...
**Prerequisite**: Since the virtual-router uses `apps/v1` deployments, the Kubernetes cluster version should be greater than 1.9.

```sh
# assumes you have a working kubeconfig, not required if operating in-cluster
go build -o virtual-router .
./virtual-router -kubeconfig=$HOME/.kube/config
